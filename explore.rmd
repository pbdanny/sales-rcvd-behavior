...
A+ .. B : Have 'type 5 - high performance' more than other group.
A+ : Have 'type 2 - the inconsistant submit' or the switching code highest contribution
Pro : Mostly contributed by 'type 3 - loyal not perform' since mostly is the new sales
DM : Interesting contributed most the 'type 1 - the dormant'
